...
# 1.  Fine-tunes an InceptionResNetV2 model on the IRMA 7T training set.

# Where the pre-trained InceptionV3 checkpoint is saved to.
PRETRAINED_CHECKPOINT_DIR=/home/obi/Documents/checkpoints

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=/home/obi/Documents/sp/07/T/modelsResV2

# Where the dataset is saved to.
DATASET_DIR=/home/obi/Documents/sp/07/T
