...
# 1. Fine-tunes an InceptionResNetV2 model on the IRMA 5D training set.
...
TRAIN_DIR=/datashare/ImageCLEF/IRMA/ImageCLEF2008/sp/05/D/modelsResV2

# Where the dataset is saved to.
DATASET_DIR=/datashare/ImageCLEF/IRMA/ImageCLEF2008/sp/05/D
