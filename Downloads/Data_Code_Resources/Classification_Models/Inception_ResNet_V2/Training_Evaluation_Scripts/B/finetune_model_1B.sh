...
# 1. Fine-tunes an InceptionResNetV2 model on the IRMA 1B training set.
...
TRAIN_DIR=/datashare/ImageCLEF/IRMA/ImageCLEF2008/sp/01/B/modelsResV2

# Where the dataset is saved to.
DATASET_DIR=/datashare/ImageCLEF/IRMA/ImageCLEF2008/sp/01/B
